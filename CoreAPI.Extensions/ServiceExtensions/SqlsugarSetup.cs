...
namespace CoreAPI.Extensions.ServiceExtensions
{
    ...
    public static class SqlsugarSetup
    {
        public static void AddSqlsugarSetup(this IServiceCollection services)
        {
            ...
            // 默认添加主数据库连接
            MainDb.CurrentDbConnId = CoreAPI.Common.Appseting.Appsettings.app(new string[] { "MainDB" });
                ...
                BaseDBConfig.MutiConnectionString.Item1.ForEach(m =>
                {
                    listConfig.Add(new ConnectionConfig()
                    {
                        ...
                        AopEvents = new AopEvents
                        {
                            ...
                            {
                                if (CoreAPI.Common.Appseting.Appsettings.app(new string[] { "AppSettings", "SqlAOP", "Enabled" }).ObjToBool())
                                {
                                    Parallel.For(0, 1, e =>
                                    {
